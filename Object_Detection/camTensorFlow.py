...
def startObjectDetect(frame_rate_calc, classes_Share, scores_Share, stopFlag , lock):
    ...
    PATH_TO_CKPT = os.path.join('/home/pi/Gripper_Control/Object_Detection/',MODEL_NAME,'frozen_inference_graph_Apple_SSDLite_ver04_rev02.pb')

    # Path to label map file
    #PATH_TO_LABELS = os.path.join('/home/pi/Gripper_Control/Object_Detection/','data','mscoco_label_map.pbtxt')
    PATH_TO_LABELS = os.path.join('/home/pi/Gripper_Control/Object_Detection/','data','label_map_Apple.pbtxt')
